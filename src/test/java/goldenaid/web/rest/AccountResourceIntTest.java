package goldenaid.web.rest;

import goldenaid.TstApp;
import goldenaid.config.Constants;
import goldenaid.domain.Authority;
import goldenaid.domain.PersistentToken;
import goldenaid.domain.User;
import goldenaid.repository.AuthorityRepository;
import goldenaid.repository.PersistentTokenRepository;
...
import goldenaid.service.dto.PasswordChangeDTO;
import goldenaid.service.dto.UserDTO;
import goldenaid.web.rest.errors.ExceptionTranslator;
import goldenaid.web.rest.vm.KeyAndPasswordVM;
import goldenaid.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = TstApp.class)
